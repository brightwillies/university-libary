  ...
  return (
    ...
    <div className='flex  flex-col gap-4'>
      ...
      <p className='text-light-100'>
        {isSignIn ? "Access the vast collection of resource, and stay updated" : "Please complete all field and upload a  valid university ID to gain access to the library"};
      </p>
